...
- Les liens de statut pointent vers les sources officielles : Zoho est suivi via `status.zoho.eu` (instance européenne) et PostFinance via `status-checkout.postfinance.ch`.
